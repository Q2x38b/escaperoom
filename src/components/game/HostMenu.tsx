...
export function HostMenu({ isOpen, onClose }: HostMenuProps) {
  ...
  return (
    <div
      className={`fixed top-16 right-4 sm:top-20 sm:right-6 z-40 w-72 sm:w-80 transition-all duration-300 ${
        isOpen
