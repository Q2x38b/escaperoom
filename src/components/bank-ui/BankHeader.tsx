      ...
      <div className="container mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:block">
            ...
            <div className="text-xs text-white/70">Secure Access Portal</div>
          </div>
        </div>
        ...
        {roomCode && (
          <div className="flex items-center gap-2">
            <span className="text-xs text-white/70 hidden sm:inline">Room:</span>
            <Button
              variant="ghost"
              size="sm"
              onClick={handleCopyCode}
              className="h-8 px-3 gap-2 font-mono text-sm tracking-wider text-white hover:bg-white/10"
            >
              {roomCode}
              {copied ? (
